...
<div align="center" class="col-lg-12">
            ...
            <form:form action="/edit-book/${currBook.getId()}" method="post" >
                ...
                <%--<form:form modelAttribute="authorWrapper">--%>

                <%--<select name="selectedA" class="autList" multiple="multiple" size="${authorsList.size()}">--%>
                <%--<c:forEach items="${authorsList}" var="author">--%>
                <%--<form:options  path="contacts[${status.index}].firstname" value="${author.getId()}">${author.getName()}/>--%>
                <%--</c:forEach>--%>
                <%--</select>--%>


                <%--<form:select  items="${authorWrapper.authorsSet}" varStatus="i" path="authorWrapper.authorsSet[${i.index}].id" multiple="multiple" size="${authorsList.size()}">--%>
